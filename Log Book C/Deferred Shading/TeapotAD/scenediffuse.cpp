...
// Default constructor
/////////////////////////////////////////////////////////////////////////////////////////////
SceneDiffuse::SceneDiffuse() : width(800), height(600)
{
}
...
void SceneDiffuse::setLightParams(QuatCamera camera)
{
	...
	prog.setUniform("Light.Target", vec3(0.0, 0.0, 0.0));
}

void SceneDiffuse::setupFBO()
{
	GLuint depthBuf, posTex, normTex, colorTex, specTex;
	...
	// The specular highlight buffer
	gl::ActiveTexture(gl::TEXTURE3);
	gl::GenTextures(1, &specTex);
	gl::BindTexture(gl::TEXTURE_2D, specTex);
	gl::TexImage2D(gl::TEXTURE_2D, 0, gl::RGBA, width, height, 0, gl::RGBA, gl::UNSIGNED_SHORT, NULL);
	gl::TexParameteri(gl::TEXTURE_2D, gl::TEXTURE_MIN_FILTER, gl::NEAREST);
	gl::TexParameteri(gl::TEXTURE_2D, gl::TEXTURE_MAG_FILTER, gl::NEAREST);
	...
	gl::FramebufferTexture2D(gl::FRAMEBUFFER, gl::COLOR_ATTACHMENT3, gl::TEXTURE_2D, specTex, 0);
...
void SceneDiffuse::pass1(QuatCamera camera)
{
	gl::BindFramebuffer(gl::FRAMEBUFFER, deferredFBO);
	...
	prog.setUniform("Material.Shininess", 100.0f / 255);
...
void SceneDiffuse::pass2(QuatCamera camera)
{
